...
contract L3ExchangeUpgradeableTest is Test, IERC721Receiver {
    ...
    address _addr3 = vm.addr(pkMaker2);
    ...
    function testExecuteAskNativeTwoItem() public {
        OrderStructs.Item[] memory items = new OrderStructs.Item[](1);
        ...
        OrderStructs.Item memory item2 = OrderStructs.Item({
            collectionType: CollectionType.ERC721,
            collection: address(erc721Sample),
            tokenId: 2,
            amount: 0,
        ...
        l3Exchange.executeOrderMultiple{value: 0.5 ether}(makerArray, taker);
    }
}
